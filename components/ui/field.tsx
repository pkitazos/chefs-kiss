...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10 gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-2 group/field-label peer/field-label flex w-fit leading-snug text-sm",
    ...
    >
      {children}
      {required && (
        <span className="text-accent absolute -top-1 -right-2 text-sm font-medium">
          *
        </span>
      )}
    </Label>
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "-my-2 h-5 text-sm/relaxed group-data-[variant=outline]/field-group:-mb-2 relative",
        className,
      )}
      {...props}
    >
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-destructive text-sm/relaxed font-normal", className)}
      {...props}
    >
      {content}
    </div>
