          ...
          <Container className="mx-auto max-w-150 p-5">
            <div className="mb-5 rounded-lg bg-gray-50 p-7.5">
              ...
              <Text className="mb-3.75 text-base">
                We&apos;re thrilled to inform you that your vendor application
                has been
...
VendorAcceptanceEmail.PreviewProps = {
  ...
  setupTime: "[Actual Setup Time]",
  boothLocation: "[Actual Booth Location (or we don't have to be so specific)]",
} as VendorAcceptanceEmailProps;
